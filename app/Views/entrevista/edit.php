        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Editar Entrevista</h1>
                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/entrevista/update') ?>" enctype="multipart/form-data">
                                                <input type="hidden" name="_method" value="PUT">
                                                <input type="hidden" name="id" value="<?= $entrevista['id_entrevista']; ?>">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="row">
                                                                ...
                                                                <?php 
                                                                 ...
                                                                 foreach ($candidatos as $candidato):
                                                                   if ($candidato['estado']==='preseleccionado') {
                                                                        $selected = ($entrevista['candidato_id'] === $candidato['id_candidato']) ? 'selected' : '';
                                                                        echo "<option value='{$candidato['id_candidato']}' $selected>{$candidato['nombre']}</option>";
                                                                   }
                                                        ...
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <?php if ($entrevista['estado']=='contratado') { ?>
                                                                    <option value="contratado" selected>Contratado</option>
                                                                    <option value="seleccionado">Seleccionado</option>
                                                                    <option value="rechazado">Rechazado</option>

                                                                <?php }elseif ($entrevista['estado']=='rechazado') {?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="observacion" placeholder="Escriba una observacion de la entrevista" rows="1"><?= $entrevista['observacion'] ?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="inputFecha">Fecha de la entrevista</label>
                                                        <input name="fecha" type="date"  class="form-control flatpickr-basic" value="<?= $entrevista['fecha'] ?>"
