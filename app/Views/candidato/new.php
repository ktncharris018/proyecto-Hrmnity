        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Agregar Candidato</h1>
                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/candidato') ?>"
                                                                ...
                                                                <?php 
                                                                 ...
                                                                 foreach ($vacantes as $vacante):
                                                                   if ($vacante['activa']==='si') {
                                                                       # code...
                                                                       echo "<option value='{$vacante['id_vacante']}''>{$vacante['nombre']}</option>";
                                                                   }
