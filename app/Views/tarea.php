        ...
        <div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<a href="https://demo.adminkit.io/pages-projects#" class="btn btn-primary float-end mt-n1"><i class="fas fa-plus"></i> New project</a>
					<div class="mb-3">
					...
					<div class="row">
								...
								<div class="card-header px-4 pt-4">
									<div class="card-actions float-end">
										<div class="dropdown position-relative">
											<a href="https://demo.adminkit.io/pages-projects#" data-bs-toggle="dropdown" data-bs-display="static">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal align-middle"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
											</a>

											<div class="dropdown-menu dropdown-menu-end">
												<a class="dropdown-item" href="https://demo.adminkit.io/pages-projects#">Action</a>
												<a class="dropdown-item" href="https://demo.adminkit.io/pages-projects#">Another action</a>
												<a class="dropdown-item" href="https://demo.adminkit.io/pages-projects#">Something else here</a>
											</div>
										</div>
									</div>
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								...
								<div class="card-header px-4 pt-4">
									<div class="card-actions float-end">
										<div class="dropdown position-relative">
											<a href="https://demo.adminkit.io/pages-projects#" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false" class="">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal align-middle"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
											</a>
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								...
								<img class="card-img-top" src="http://localhost/hrm-system/public/static/img/photos/unsplash-3.jpg" alt="Unsplash">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								...
								<img class="card-img-top" src="./Projects_files/unsplash-2.jpg" alt="Unsplash">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								...
								<img class="card-img-top" src="./Projects_files/unsplash-3.jpg" alt="Unsplash">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								...
								<img class="card-img-top" src="./Projects_files/unsplash-1.jpg" alt="Unsplash">
