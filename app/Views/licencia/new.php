                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/licencia') ?>" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="fecha_inicio" type="date"  class="form-control flatpickr-basic"
                                                            id="inputFechaInicio" placeholder="Seleccione la fecha">
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="fecha_final" type="date"  class="form-control flatpickr-basic"
                                                            id="inputFechaFinal" placeholder="Seleccione la fecha">
                                                    </div>
