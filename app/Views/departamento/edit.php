                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/departamento/update') ?>">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <input type="hidden" name="_method" value="PUT">
                                                    <input type="hidden" name="id" value="<?= $departamento['id_departamento']; ?>">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="input
                                                        name">Nombre del
                                                            Departamento</label>
                                                        <input name="nombre" type="text" class="form-control" value="<?=$departamento['nombre']?>"
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <select name="estado" id="inputdestado" class="form-control">
