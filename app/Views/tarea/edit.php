                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <?= print_r($empleadoSelected)?>
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/tarea/update') ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="nombre" type="text" class="form-control"
                                                        id="inputUsername" placeholder="Username" value="<?= $tarea['nombre'] ?>">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Descripcion</label>
                                                    <textarea class="form-control" name="descripcion" placeholder="Escriba una descripcion de la vacante" rows="1"><?= $tarea['descripcion'] ?></textarea>
                                                </div>
                                                <div class="mb-3">
                                                            ...
                                                            <select class="choices-multiple-remove-button form-control" multiple name="empleados[]" id="choices-multiple-remove-button" data-trigger placeholder="Eliga los empleados...">
                                                                ...
                                                                <optgroup>
                                                                    ...
                                                                    foreach ($empleadoSelected as $empleadoSelect):
                                                                            echo "
                                                                            <option value='{$empleadoSelect['id_empleado']}'' selected>{$empleadoSelect['nombre']}</option>
                                                                            ";
                                                                    endforeach;      
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <select name="progreso" id="inputdepar"
                                                                ...
                                                                <?php 
                                                                 ...
                                                                 foreach ($progresoTarea as $progreso):
                                                                    $selected = ($progreso === $tarea['progreso']) ? 'selected' : '';

                                                                    echo "<option value='{$progreso}' $selected>{$progreso} %</option>";
                                                                 endforeach;      
                                                        ...
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <select name="estado" id="inputEstado" class="form-control">
                                                               ...
                                                               <?php }else if($tarea['estado']==='Pendiente'){?> 
                                                                    <option value="Pendiente" selected>Pendiente</option>
                                                                    <option value="Finalizada">Finalizada</option>
                                                                    <option value="En avance">En avance</option>
                                                                <?php }else{ ?>
                                                                    <option value="Finalizada">Finalizada</option>
                                                                    <option value="En avance" selected>En avance</option>
                                                                <?php }?>
                                                            </select>
                                                        </div>
                                                    </div>
