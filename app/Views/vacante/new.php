        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Agregar Vacante</h1>
                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/vacante') ?>"
                                            ...
                                            <div class="">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input name="titulo_profesional" type="text" class="form-control"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <select name="activa" id="inputEstado"
                                                                class="form-control">
                                                                <option selected>Elegir...</option>
