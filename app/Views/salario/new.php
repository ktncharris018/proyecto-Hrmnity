                    ...
                    <div class="">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" class="ajax-form" action="<?= base_url('public/salario') ?>" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="salario_base" type="text" class="form-control formatear-numero"
                                                            id="inputsalario" placeholder="Ingrese la cifra sin comas y puntos (. ,)">
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="aux_transporte" type="text" class="form-control formatear-numero"
                                                            ...
                                                            title="por favor no escriba : coma y puntos">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" name="deduccion_salud" type="checkbox" id="flexSwitchCheckDefault">
                                                        ...
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" name="deduccion_pension" type="checkbox" id="flexSwitchCheckChecked">
